...
$(document).ready(function () {
    $('#uploadFile').change(function (event) {
        ...
        if ($('#uploadFile').val()) {
        console.log("<source src="+$("#uploadFile").val()+" type='video/mp4'>")
...
function handleFiles(files) {
    ...
    fetch('/classify', {
        ...
        console.log($('#videoRef'), model, $("#canvasRef"))
        detectVideo(document.getElementById('videoRef'), model, document.getElementById("canvasRef"))
        })
//                    console.log(
//                        "<img src='/video_feed/" +
//                            data.file +
